      ...
      <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
        ...
        {isDraftMode && (
          <button
            ...
            className="px-3.5 py-1.5 rounded-md bg-amber-700/60 border border-amber-500/40 text-amber-100 hover:bg-amber-700 text-[12.5px] font-medium transition-all flex-shrink-0"
          >
            Exit Draft
          </button>
        )}
